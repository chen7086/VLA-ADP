...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    @staticmethod
    def _compute_qk_importance_generic(language_model: PreTrainedModel,
        ...
        if is_gpt2:
            ...
            H = qkv_text.shape[-1] // 3
            q_text = qkv_text[..., :H]
            k_vis = qkv_vision[..., H:2 * H]
    ...
    def _run_diffusion_prediction(
        ...
        for t in action_head.noise_scheduler.timesteps:
            ...
            actions_hidden_states = last_hidden_states[
                :,
                1 + NUM_PATCHES + NUM_PROMPT_TOKENS : 1 + NUM_PATCHES + NUM_PROMPT_TOKENS + ACTION_DIM * NUM_ACTIONS_CHUNK,
                :,
            ]  # (B, act_chunk_len, D)
    ...
    def predict_action(
        ...
        **kwargs: str,
        ...
        # Cache the actual number of visual patches after (optional) dropping for correct indexing later
